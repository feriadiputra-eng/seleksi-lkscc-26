document.addEventListener('DOMContentLoaded', function () {
    ...
    form.addEventListener('submit', async function (e) {
        ...
        try {
            ...
            const response = await fetch('https://yog36j95jl.execute-api.us-west-2.amazonaws.com/dev/dev', { 
                method: 'POST',
                headers: {
    ...
    async function fetchData() {
        try {
            const response = await fetch('https://yog36j95jl.execute-api.us-west-2.amazonaws.com/dev/dev'); // Ganti dengan GET endpoint
